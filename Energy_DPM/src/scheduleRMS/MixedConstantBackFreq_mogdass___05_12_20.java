 ...
 *  DYNAMIC 
 */
public class MixedConstantBackFreq_mogdass___05_12_20 {
	//GLOBAL PARAMETERS
			...
			boolean faultFromFile,double bcetRatio, long hyper, int n_proc) throws IOException
	{
		...
		System.out.println("STARTING MixedConstantBackFreq_mogdass___05_12_20  no. of processors "+m);
		...
		String filename= outputFolder+"allocationmogdass "+"_"+inputfilename+"_"+date;
		String filename4= outputFolder+"taskProcmogdass "+"_"+inputfilename+"_"+date+".txt"; // TEMP USE
		String filename1= outputFolder+"schedulemogdass "+"_"+inputfilename+"_"+date+".txt";
		String filename2= outputFolder+"energymogdass "+"_"+inputfilename+"_"+date+".txt";
		String filename3= outputFolder+"tasksmogdass "+"_"+inputfilename+"_"+date+".txt";
		String filename5= outputFolder+"analysismogdass "+"_"+inputfilename+"_"+date+".txt";
		String filename7= outputFolder+"faultmogdass "+"_"+inputfilename+"_"+date+".txt";
        ...
        ///////setRelib_Mogdhaddas(ArrayList<ITask> taskset, double fMin, double freq, int d)
        	...
        	reliab.setRelib_Mogdhaddas(taskset, CRITICAL_freq,  d);
		...
		//	partition.allocatio_WFD_Mogdas(taskset, freeProcList, filename,0.7);
			
			
		//	18-12-18
		//	partition.allocation_M_WFD_MOG(taskset, freeProcList, filename);
			
			
		//	partition.allocatio_WFD(taskset, freeProcList, filename,0.8);
		...
		//	partition.alloc_Prioritywise_threshold(taskset, freeProcList, filename, threshold);
	     	...
	     	for(Processor p : freeProcList)
			{
	     		...
	     		{
	     				System.out.println("p  "+p.getId()+" t "+t.getId()+"freq  "+t.getFrequency());
...
*/
		...
		while(itr.hasNext())
			 ...
			 */
			writer_schedule.write("\nmogdassP_ID TASKID FREQ WCET wcet_o ACET BCET DEADLINE P/B RESP promo\n");
...
*/
			...
			/*  for(Processor p : freeProcList)
        {
			...
			System.out.println("  mogdass  fq    "+maxfq +"  tasksets  "+total_no_tasksets+" energy  "+energyTotal);
		...
		System.out.println("finish mogdass ");
	}
