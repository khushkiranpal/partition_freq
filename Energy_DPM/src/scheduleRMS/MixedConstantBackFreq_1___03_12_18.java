 ...
 *  DYNAMIC 
 */
public class MixedConstantBackFreq_1___03_12_18 {
	//GLOBAL PARAMETERS
			...
			boolean faultFromFile,double bcetRatio, long hyper, int n_proc, String partitioning) throws IOException
	{
		...
		System.out.println("STARTING MixedConstantFreq1_03_12_18  no. of processors "+m);
		...
		String filename= outputFolder+"allocationConstantFreq "+"_"+inputfilename+"_"+date;
		String filename4= outputFolder+"taskProcConstantFreq "+"_"+inputfilename+"_"+date+".txt"; // TEMP USE
		String filename1= outputFolder+"scheduleConstantFreq "+"_"+inputfilename+"_"+date+".txt";
		String filename2= outputFolder+"energyConstantFreq "+"_"+inputfilename+"_"+date+".txt";
		String filename3= outputFolder+"tasksConstantFreq "+"_"+inputfilename+"_"+date+".txt";
		String filename5= outputFolder+"analysisConstantFreq "+"_"+inputfilename+"_"+date+".txt";
		String filename7= outputFolder+"faultConstantFreq "+"_"+inputfilename+"_"+date+".txt";
  ...
  //  	System.out.printf("  pof_1 %.25f\n ",pof_1);
		...
		/*	double difference=0;
			...
			for(Processor p : freeProcList)
			{
				...
				//System.out.println(" p "+p.getId()+"   load   " +load+" LLB_N  "+LLB_N );
				double slack ;
				//5-12-18 LLB_N
				slack = Math.max(0, (LLB_N- load));//Math.max(0, (1- load));
...
//						break;
	    ...
	    /* 	////////////////RELIABILITY////////////5-12-18
		        ...
		        ///////setRelib_Mogdhaddas(ArrayList<ITask> taskset, double fMin, double freq, int d)
		        	reliab.setRelib_original(taskset, CRITICAL_freq, 1, d);
		     	double PoF_1;
		    // 	PoF_1= 1- reliab.reliabilitySystem(taskset);
		     	PoF_1= reliab.POFSystem(taskset);
		     	System.out.println("PoF_1 "+PoF_1 );//String.format("%.40f", PoF_1));
		     	double PoF_f ;
		     	
		     	//Mixed allocation scheme5-12-18
		     	reliab.setRelib_Mixed(taskset,freeProcList, CRITICAL_freq, d);
		     	PoF_f =reliab.POFSystem(taskset);
		     	System.out.println("PoF_1 "+String.format("%.40f", PoF_1)+ " \n PoF_f  "+String.format("%.40f", PoF_f));
		    	
		     	
		     	*/// NO NEED AS BACKUP FREQ =1
...
*/
			...
			/*  for(Processor p : freeProcList)
        {
			...
			System.out.println("  ConstantFreq  fq    "+maxfq +"  tasksets  "+total_no_tasksets+" energy  "+energyTotal);
	...
	/*	writer_tasks.close();
		...
		System.out.println("finish ConstantFreq ");
	}
