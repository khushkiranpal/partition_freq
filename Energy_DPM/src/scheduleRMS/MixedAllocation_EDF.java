...
import queue.SortedJobQueueDeadline;
import queue.SortedQueueDeadline;
 ...
 *  DYNAMIC 
 */
public class MixedAllocation_EDF {
		//GLOBAL PARAMETERS
...
*/	
	...
	public void schedule(String inputfilename,String outputFolder,String inputFolder, 
			long hyperperiod_factor, int d,double CRITICAL_TIME,double CRITICAL_freq,boolean faultFromFile,double bcetRatio) throws IOException
	{
		 System.out.println("STARTING MixedAllocation_EDF");
    ...
    String filename= outputFolder+"allocationMixed_EDF"+"_"+inputfilename+"_"+date+".txt";
    String filename4= outputFolder+"taskProcMixed_EDF"+"_"+inputfilename+"_"+date+".txt"; // TEMP USE
 	String filename1= outputFolder+"scheduleMixed_EDF"+"_"+inputfilename+"_"+date+".txt";
    String filename2= outputFolder+"energyMixed_EDF"+"_"+inputfilename+"_"+date+".txt";
    String filename3= outputFolder+"tasksMixed_EDF"+"_"+inputfilename+"_"+date+".txt";
    String filename5= outputFolder+"analysisMixed_EDF"+"_"+inputfilename+"_"+date+".txt";
    String filename7= outputFolder+"faultMixed_EDF"+"_"+inputfilename+"_"+date+".txt";
 ...
 //  Writer writer_taskProcWise = new FileWriter(filename4);
    ...
    writer_energy.write("Mixed_EDFTASKSET UTILIZATION MIN_FREQ MAX_FREQ TOTAL_E "
    		+ "P_ACTIVE_TIME P_IDLE_TIME P_SLEEP S_ACTIVE_TIME S_IDLE_TIME S_SLEEP");
      writer_tasks.write("Mixed_EDFfullBackupsExecuted partialBackupsExecuted fullBackupsCancelled"
  ...
  //  writer_taskProcWise.write("proc primary  backup  total"); //  TEMP USE
		writer_fault.write("\nMixed_EDFTASKSET TIME PRI_PROC QUE TASKID JOBID WCET PROM DEADLINE");
    ...
    while ((set = reader.nextTaskset()) != null) // SCHEDULING STARTS FOR ALL TASKSETS IN FILE
    {
    	...
    	ISortedQueue queue = new SortedQueueDeadline ();
    	queue.addTasks(set);
  ...
  /* 	for(Processor pMin : freeProcList)
	...
	/*	writer_allocation.write("\n"+"FAULT  \t\t");
    	...
    	long temp=0;
		ISortedJobQueue activeJobQ = new SortedJobQueueDeadline(); // dynamic jobqueue 
...
//		//System.out.println("activationTimes  "+activationTimes.size()+"  promotionTimes  "+promotionTimes.size());
		...
		while(itr.hasNext())
	  	...
	  	*/
		 writer_schedule.write("\nMixedP_ID TASKID FREQ WCET ACET BCET DEADLINE P/B RESP promo\n");
	...
	//	writer_analysis.write("P_ID TASKID JOBID PR/BK TIME");
     ...
     //   	System.out.println("TIME  "+time+"  p  "+proc.getId()+"  idle "+ proc.idleTime);;
       ...
       /* for(Processor p : freeProcList)
        ...
        System.out.println("  mixed_EDF fq    "+maxfq +"  tasksets  "+total_no_tasksets+" energy  "+energyTotal);
 ...
 //   writer_analysis.close();
  //  writer_taskProcWise.close();
    System.out.println("finish mixed_EDF");
	}
