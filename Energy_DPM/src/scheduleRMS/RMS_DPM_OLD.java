...
public class RMS_DPM_OLD{
	...
	{
		System.out.println("STARTING RMS_DPM_OLD");
		...
		String filename= outputFolder+"primaryRMS_DPM_OLD"+"_"+inputfilename+"_"+date+".txt";
		String filename2= outputFolder+"energyRMS_DPM_OLD"+"_"+inputfilename+"_"+date+".txt";
	//	Writer writer_primary = new FileWriter(filename);
		...
		writer_energy.write("RMS_DPM_OLDTASKSET UTILIZATION fq PRIMARY_ENERGY SUCCESS fail\n");
...
*/
	...
	/*	//14-12-18
			...
			System.out.println("RMS_DPM_OLD   fq    "+"    tasksets  "+total_no_tasksets+"  energy  "+ Double.valueOf(twoDecimals.format(primary.getEnergy_consumed())));
	...
	//	writer_primary.close();
		...
		System.out.println("success RMS_DPM_OLD");
	}
